...
import { getQuestions , selectQuestionStatus } from '../questionSlice';
...
//import style
import style from './QuestionFilterBar.module.css';

function QuestionFilterBar({handleAdd}){
        ...
        <div className={style['bar']}>   
            ...
            <div style={{marginBottom: '5px'}}>
                <Button width="150px" height="40px" onClick={handleAdd}>
                    <ImPlus size="13px" color='white'style={{marginRight: '8px'}}/> Add question
                </Button>
            </div>
        </div>
    );
